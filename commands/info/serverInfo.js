module.exports = {
    name: "serverinfo",
    aliases: ["server-info", "serverinformation", "server-information", "server", "details", "guildinfo", "guild-info", "guildinformation", "guild-information"],
    code: `
      $title[Server Info]
      ...
      $cooldown[5s; Slow down! Don't spam the command! **Time left:** \`%time%\`]
